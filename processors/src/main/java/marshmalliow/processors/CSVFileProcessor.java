...
import marshmalliow.annotations.CSVFile;

@SupportedAnnotationTypes("marshmalliow.annotations.CSVFile")
...
public class CSVFileProcessor extends AbstractProcessor {
	...
	public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
		for(final Element element : roundEnv.getElementsAnnotatedWith(CSVFile.class)) {
